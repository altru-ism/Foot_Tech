...
const generateConsistentLocationData = (
  ...
  // Generate a daily breakdown (Mon-Sun) using multipliers for realism
  const base = totalCurrentTraffic;
  ...
  const [monday, tuesday, wednesday, thursday, friday, saturday, sunday] = dailyMultipliers.map(m => Math.floor(base * m));
