  ...
  return (
    <div className={`min-h-screen overflow-hidden auth-container signup-container ${comingFromSignIn ? 'slide-in-from-left' : ''} ${isNavigating ? 'slide-out' : ''}`}>
      <div className="flex min-h-screen">
        ...
        <div className="w-full md:w-1/2 flex flex-col p-8 justify-center items-center bg-white">
          ...
          <div className="max-w-md w-full">
            ...
            <p className="text-black mb-8 text-center drop-shadow-md">Enter your details to create an account</p>
            ...
            <form className="w-full" onSubmit={handleEmailSignUp}>
              ...
              <div className="text-center my-2 text-black">or</div>
