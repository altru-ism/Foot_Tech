...
import TrafficDwellRatioChart from '@/components/dashboard/TrafficDwellRatioChart';
import PathEfficiencyChart from '@/components/dashboard/PathEfficiencyChart';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 flex flex-col gap-6">
          ...
          <WeeklySummaryChart 
            ...
            tuesday={weeklySummaryData.tuesday}
            wednesday={weeklySummaryData.wednesday}
            thursday={weeklySummaryData.thursday}
            friday={weeklySummaryData.friday}
            saturday={weeklySummaryData.saturday}
            sunday={weeklySummaryData.sunday}
            total={weeklySummaryData.total}
          />
          
          <TrafficDwellRatioChart 
            locations={timeSeriesData.locations.map(loc => ({
              name: loc.name,
              color: loc.color,
